...
write.table(efdrMat, "efdrMatPartialAsymmDiffMRNA.txt")
...
write.table(efdrSDMat, "efdrSDMatPartialAsymmDiffMRNA.txt")
...
write.table(powerMat, "powerMatPartialAsymmDiffMRNA.txt")
...
write.table(powerSDMat, "powerSDMatPartialAsymmDiffMRNA.txt")
...
write.table(MSEMat, "MSEMatPartialAsymmDiffMRNA.txt")
