...
write.table(efdrMat, "efdrMatPartialAsymmDiffMRNA_prm2.txt")
...
write.table(efdrSDMat, "efdrSDMatPartialAsymmDiffMRNA_prm2.txt")
...
write.table(powerMat, "powerMatPartialAsymmDiffMRNA_prm2.txt")
...
write.table(powerSDMat, "powerSDMatPartialAsymmDiffMRNA_prm2.txt")
...
write.table(MSEMat, "MSEMatPartialAsymmDiffMRNA_prm2.txt")
