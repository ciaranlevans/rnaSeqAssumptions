...
write.table(efdrMat, "efdrMatPartialAsymmSameMRNA.txt")
...
write.table(efdrSDMat, "efdrSDMatPartialAsymmSameMRNA.txt")
...
write.table(powerMat, "powerMatPartialAsymmSameMRNA.txt")
...
write.table(powerSDMat, "powerSDMatPartialAsymmSameMRNA.txt")

MSEMat <- data.frame(MSEMat)
colnames(MSEMat) <- 
  c("Oracle", "Total Count", "DESeq", "edgeR", "TCC", "PoissonSeq")

write.table(MSEMat, "MSEMatPartialAsymmSameMRNA.txt")
