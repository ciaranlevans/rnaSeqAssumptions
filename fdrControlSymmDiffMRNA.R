...
write.table(efdrMat, "efdrMatSymmDiffMRNA.txt")
...
write.table(efdrSDMat, "efdrSDMatSymmDiffMRNA.txt")
...
write.table(powerMat, "powerMatSymmDiffMRNA.txt")
...
write.table(powerSDMat, "powerSDMatSymmDiffMRNA.txt")
...
write.table(MSEMat, "MSEMatSymmDiffMRNA.txt")